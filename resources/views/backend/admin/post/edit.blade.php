                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="published" id="published" class="form-control" value="{{ date($post->published) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @enderror" id="gambar">
                                 ...
                                 @enderror
                              <div id="previewImage" style="margin-top: 10px;">
                                    <img src="{{ asset('storage/' . $post->image) }}" alt="Preview Gambar" style="max-width: 100%; height: auto;">
                             </div>
                            </div>
                            <!-- Tombol Submit -->
                            <div class="form-group">
